...
class WorkflowConfigTransitionRoleForm extends WorkflowConfigTransitionFormBase {
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    if ($workflow) {
      ...
      /** @var $states \Drupal\workflow\Entity\WorkflowState[] */
      $states = $workflow->getStates($all = 'CREATION');
      if ($states) {
        ...
        foreach ($states as $state) {
          ...
          /** @var $to_state \Drupal\workflow\Entity\WorkflowState */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($form_state->getValue($this->entitiesKey) as $from_sid => $to_data) {
      foreach ($to_data as $transition_data) {
        /** @var $config_transition \Drupal\workflow\Entity\WorkflowConfigTransition */
    ...
    $this->messenger()->addStatus(t('The workflow was updated.'));
  }
