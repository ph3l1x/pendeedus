...
/**
 * Class WorkflowTransitionRevertForm.
 * @package Drupal\workflow_operations\Form
 */
class WorkflowTransitionRevertForm extends EntityConfirmFormBase {
   ...
   * the Transition is not completely a complete Entity. @todo
   *
   * {@inheritdoc}
   */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addWarning($this->t($comment));
